...
int main(int argc, const char **argv) {
  ...
  float end_y;
  std::cout << "----------------------------" << std::endl;
  std::cout << "Enter x starting poisition: " << std::endl;
  std::cin >> start_x;
  std::cout << "----------------------------" << std::endl;
  std::cout << "Enter y starting poisition: " << std::endl;
  std::cin >> start_y;
  std::cout << "----------------------------" << std::endl;
  std::cout << "Enter x ending poisition: " << std::endl;
  std::cin >> end_x;
  std::cout << "----------------------------" << std::endl;
  std::cout << "Enter y ending poisition: " << std::endl;
  std::cin >> end_y;
  std::cout << "----------------------------" << std::endl;
